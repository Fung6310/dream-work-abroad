...
// Pure input form — this page is deliberately filter-only. Submitting builds
// a URL from these inputs and navigates to /undergraduate/results, which
// renders only the matched list with no filter UI of its own. That split
// (rather than the old inline-results-on-the-same-page pattern) means a
// search is a real URL: shareable, bookmarkable, safe to open in a new tab,
// and restorable on browser back — see the ux-ui-audit finding this
// addresses in docs/ARCHITECTURE.md.
